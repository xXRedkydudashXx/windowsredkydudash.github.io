...
clippy.BASE_PATH="C/System33/Libraries/ClippyJS/agents/"
...
clippy.reload = function (name) {      // The same function but returns the agent -- xXRedkydudashXx
    try {
    var path = clippy.BASE_PATH + name;
    ...
    return new clippy.Agent(path, data,sounds)
    } catch (error) {}
}
